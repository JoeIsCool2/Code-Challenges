...
func alphaSort(words: [String]) -> [String] {
    words.sorted(by: >)
}

func sortEverything(words: [String]) -> [String] {
    words.map{ String($0.lowercased().sorted(by: >))}.sorted(by: >)
}

print(sortEverything(words:["Vern", "Gidget", "Zeb"]))
